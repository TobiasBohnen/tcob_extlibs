...
#if defined(__MORPHOS__) || defined(__AROS__) || defined(AMIGAOS) || defined(__amigaos__) || defined(__amigaos4__) || defined(__amigados__) || defined(AMIGA) || defined(_AMIGA) || defined(__AMIGA__)
...
void CLIB_DECL D_(const char* text, ...) ATTR_PRINTF(1, 2);
        ...
        #if _MSC_VER < 1400
void __inline CLIB_DECL D_(const char* text, ...)
{
    do {
    } while (0);
}
...
/* Format quirks */
#define QUIRKS_ST3 (QUIRK_S3MLOOP | QUIRK_VOLPDN | QUIRK_FINEFX | QUIRK_S3MRTG | QUIRK_MARKER | QUIRK_RSTCHN)
#define QUIRKS_FT2 (QUIRK_RTDELAY | QUIRK_FINEFX)
#define QUIRKS_IT (QUIRK_S3MLOOP | QUIRK_FINEFX | QUIRK_VIBALL | QUIRK_ENVFADE | QUIRK_ITVPOR | QUIRK_KEYOFF | QUIRK_VIRTUAL | QUIRK_FILTER | QUIRK_RSTCHN | QUIRK_IGSTPOR | QUIRK_S3MRTG | QUIRK_MARKER)
